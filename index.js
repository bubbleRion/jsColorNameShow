window.onload = function () {
  ...
  var redC = document.querySelector('.brown');
  var greenC = document.querySelector('.green');
  var blueC = document.querySelector('.blue');
  var yellowC = document.querySelector('.yellow');
